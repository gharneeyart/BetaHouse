            ...
            <div className="">
                        ...
                        <div className="flex flex-col gap-y-4">
                          <div className="flex flex-col md:flex-row gap-x-11 gap-y-1.5 md:gap-y-0">
                                  <div className="flex flex-col gap-y-1.5">
                                      ...
                                      <input type="text" placeholder='Enter Name' className='border-[2.5px] w-[330px] md:w-[300px] lg:w-[218px] h-12 rounded py-3.5 px-3 outline-none' onChange={handleFirstNameChange} />
                                  ...
                                  <div className="flex flex-col gap-y-1.5">
                                      ...
                                      <input type="text" placeholder='Enter Name' className='border-[2.5px] w-[330px] md:w-[300px] lg:w-[218px] h-12 rounded py-3.5 px-3 outline-none' onChange={handleLastNameChange} />
                              ...
                              <div className="flex flex-col gap-y-1.5">
                                  ...
                                  <input type="text" placeholder='Enter your Email' className='border-[2.5px] w-[330px] md:w-full lg:w-[480px] h-12 rounded py-3.5 px-5 outline-none' onChange={handleEmailChange} />
                                  {errors.email && <div className="text-red-500">{errors.email}</div>}
                              </div>
                              <div className="flex flex-col gap-y-1.5">
                                  <label className='font-medium text-white lg:text-[#181A20D1]'>Password</label>
                                  <input type="password" placeholder='Enter your Password' className='border-[2.5px] w-[330px] md:w-full lg:w-[480px] h-12 rounded py-3.5 px-5 outline-none' onChange={handlePasswordChange} />
                                  {errors.password && <div className="text-red-500">{errors.password}</div>}
                              </div>
                              <div className="flex flex-col gap-y-1.5">
                                  <label className='font-medium text-white lg:text-[#181A20D1]'>Confirm Password</label>
                                  <input type="password" placeholder='Confirm your Password' className='border-[2.5px] w-[330px] md:w-full lg:w-[480px] h-12 rounded py-3.5 px-5 outline-none' onChange={handleConfirmPasswordChange} />
                          ...
                          <button className='bg-[#3D9970] w-[330px] md:w-full lg:w-[482px] rounded-2xl h-16 text-[22px] text-[#FFFFFF]' type="submit" onSubmit={handleSubmit} disabled={loading}>{loading ? 'Signing in...' : 'Sign in'}</button>
                      </form>
                  </div>
              <div className="flex flex-col gap-y-8">
                  <div className="flex flex-col gap-y-3.5">
                      ...
                      <button className='w-[330px] md:w-full lg:w-[482px] rounded-2xl border border-white lg:border-black h-16 flex justify-center items-center gap-x-2.5 text-white lg:text-black'>
                          <img src={Google} alt="" />
