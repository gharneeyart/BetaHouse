...
const Hero = () => {
  return (
    <div className='herobg h-[680px] flex flex-col justify-center items-center'>
        <div className="flex flex-col justify-center items-center gap-y-12 w-[1158px] md:mx-12 mt-40">
            <div className="w-[988px] text-center flex flex-col justify-center items-center text-[#FFFFFF] gap-y-5">
            ...
            <div className="h-96 md:h-[135px] w-[376px] md:w-[920px] lg:w-[1158px] bg-[#FFFFFF33] flex justify-center items-center mb-20 md:mb-0">
                <div className="w-[356px] md:w-[860px] lg:w-[1108px] h-80 md:h-[85.74px] rounded-lg bg-[#FFFFFF] flex flex-col md:flex-row items-center justify-center ">
