...
const Hero = () => {
  return (
    <div className='herobg container mx-auto h-[680px] flex flex-col justify-center items-center w-full'>
        <div className="flex flex-col justify-center items-center gap-y-14 w-[1158px] md:mx-12 mt-40 md:mt-12 ">
            ...
            <div className="h-96 md:h-[135px] w-[336px] md:w-[920px] lg:w-[1030px] bg-[#FFFFFF33] flex justify-center items-center mb-20 md:mb-0">
                <div className="w-[316px] md:w-[860px] lg:w-[980px] h-80 md:h-[85.74px] rounded-lg bg-[#FFFFFF] flex flex-col md:flex-row items-center justify-center ">
