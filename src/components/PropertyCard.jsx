...
const PropertyCard = ({property}) => {
  return (
    <div className='border w-[336.33px] lg:min-w-[346.33px] h-[515.24px] md:h-[545.24px] lg:h-[525.24px] rounded-lg'>
      ...
      <div className="absolute top-0 left-0 p-5 flex flex-col gap-y-32 md:gap-y-[120px] lg:gap-y-32">
        <div className="flex justify-between gap-x-[100px] lg:gap-x-28 mb-2">
